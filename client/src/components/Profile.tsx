...
function Profile() {
  return (
    <div className="align-center m-auto flex w-[150px] flex-col">
      <img
        className="h-[150px] w-[150px] rounded-[50%] object-cover p-[5px] shadow-profile1 shadow-profile2"
        src={profilePhoto}
      ...
      <ul className="flex list-none justify-between p-0">
        <li className="m-auto">
          ...
          >
            <img
              className="mt-[20px] h-auto w-[32px] transform rounded-[50%] p-[2px] shadow-logo1 shadow-logo2 transition-transform duration-200 ease-in-out hover:scale-[1.2]"
              src={linkedInLogo}
